  ...
  " />
            ...
            ">
                    ...
                    <div style="margin-bottom: 15px;">
                        <a href="#"
                            style="color: white; text-decoration: none; display: block; margin-bottom: 10px;">BUY THE
                            ISSUE</a>
        ...
        <div class="bottle" style="text-align: center; padding: 20px;">
            <div style="margin: 0 auto; max-width: 800px;">
                <h2 style="font-size: 32px; line-height: 1.4;">Dua Lipa et Callum Turner se seraient secrètement
                    fiancés</h2>
            </div>
            <p style="margin: 0 auto; max-width: 600px; font-size: 16px; line-height: 1.6; color: #555;">La chanteuse
                et l’acteur semblent avoir officialisé leurs fiançailles pendant les fêtes. Entre amour discret et
                projets futurs, le couple enchante leurs fans avec cette grande annonce.</p>
        ...
        <div class="bottle" style="margin: 0 auto; max-width: 800px; padding: 20px;">
            <h4 style="font-weight: 100; font-size: 16px; line-height: 1.6;">Dua Lipa, connue pour ses nombreux succès
                musicaux, a récemment terminé la première partie de sa tournée dans les stades et est rentrée au
                Royaume-Uni pour les fêtes de fin d’année. Callum Turner, quant à lui, est reconnu pour ses rôles dans
                des films tels que <i>Queen and Country</i> et la série <i>Les Animaux fantastiques</i>, où il incarne
                Theseus Scamander. Le couple, qui a maintenu une certaine discrétion sur leur relation, semble plus
                épanoui que jamais. Des photos récentes les montrent heureux et amoureux, renforçant l’enthousiasme de
                leurs fans pour cette nouvelle étape de leur vie commune.</h4>
        </div>

        <section class="bottle" style="margin-top: 50px; padding: 20px;">
            <div class="section"
                style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 20px; max-width: 1200px; margin: auto;">
                <div style="flex: 1 1 calc(33.33% - 20px);    overflow: hidden;">
                    ...
                    <div style="padding: 15px;">
                        <div style="color: #666; font-size: 14px; text-transform: uppercase; margin-bottom: 10px;">
                            Voyage</div>
                        <div style="font-size: 18px; font-weight: bold; margin: 0 0 10px;">Evasion hivernale :
                            l’excellence des séjours au ski avec Airelles</div>
                ...
                <div style="flex: 1 1 calc(33.33% - 20px);    overflow: hidden;">
                    ...
                    <div style="padding: 15px;">
                        <div style="color: #666; font-size: 14px; text-transform: uppercase; margin-bottom: 10px;">
                            Femmes</div>
                        <div style="font-size: 18px; font-weight: bold; margin: 0 0 10px;">Mocha Mousse : la couleur
                            Pantone 2025 nous envûte cette saison</div>
                        <div style="font-size: 14px; color: #999;">31.12.2024 by Pauline Borgogno</div>
                    </div>
                </div>
                <div style="flex: 1 1 calc(33.33% - 20px);    overflow: hidden;">
                    ...
                    <div style="padding: 15px;">
                        <div style="color: #666; font-size: 14px; text-transform: uppercase; margin-bottom: 10px;">Pop
                            Culture</div>
                        <div style="font-size: 18px; font-weight: bold; margin: 0 0 10px;">3 ouvrages mode à dévorer
                            pour commencer l’année avec style</div>
                        <div style="font-size: 14px; color: #999;">31.12.2024 by Pauline Borgogno</div>
                    </div>
                </div>
            </div>
        ...
        <div style="position: fixed; top: 50%; left: 40px; transform: translateY(-50%); display: block;"
            class="social-bar">
            <a href="#"
                style="display: block; margin-bottom: 10px; text-decoration: none; color: black; font-size: 20px;">
    ...
    <section style="position: relative;
      ...
      ">
        ...
        <div style="background-color: black; ">
            ...
            <div class="section"
                style="margin-top:200px; display:  flex; flex-wrap: wrap; justify-content: space-between; gap: 25px; max-width: 1270px; margin: auto;">
                <div style="flex: 1 1 calc(25% - 20px);    overflow: hidden;">
                    ...
                    <div style="padding: 15px;">
                        <div style="color: #666; font-size: 14px; text-transform: uppercase; margin-bottom: 10px;">
                            Voyage</div>
                        <div style="font-size: 18px; font-weight: bold; margin: 0 0 10px; color:white;">Evasion
                            hivernale : l’excellence des séjours au ski avec Airelles</div>
                        <div style="font-size: 14px; color: #999;">31.12.2024 by Pauline Borgogno</div>
                    </div>
                </div>
                <div style="flex: 1 1 calc(25% - 20px);    overflow: hidden;">
                    ...
                    <div style="padding: 15px;">
                        <div style="color: #666; font-size: 14px; text-transform: uppercase; margin-bottom: 10px;">
                            Femmes</div>
                        <div style="font-size: 18px; font-weight: bold; margin: 0 0 10px; color:white;">Mocha Mousse :
                            la couleur Pantone 2025 nous envûte cette saison</div>
                        <div style="font-size: 14px; color: #999;">31.12.2024 by Pauline Borgogno</div>
                    </div>
                </div>
                <div style="flex: 1 1 calc(25% - 20px);    overflow: hidden;">
                    ...
                    <div style="padding: 15px;">
                        <div style="color: #666; font-size: 14px; text-transform: uppercase; margin-bottom: 10px;">Pop
                            Culture</div>
                        <div style="font-size: 18px; font-weight: bold; margin: 0 0 10px; color:white;">3 ouvrages mode
                            à dévorer pour commencer l’année avec style</div>
                        <div style="font-size: 14px; color: #999;">31.12.2024 by Pauline Borgogno</div>
                    </div>
                </div>
