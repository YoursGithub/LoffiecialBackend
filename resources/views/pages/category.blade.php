        ...
        * {
        ...
        .hero {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),
                url('/images/ramesh.webp') center/cover no-repeat;
            color: white;
            display: flex;
  ...
  ">
    ...
    <section class="bottle hexx" style="font-family: 'Sen', sans-serif">
        ...
        ">
            <article style="width: 100%; text-align: left">
                <img src="/images/girls.jpeg" alt="BE WELL"
            ...
            <article style="width: 100%; text-align: left">
                <img src="/images/heyy.jpg" alt="FOOD" style="width: 100%; height: auto; margin-bottom: 15px" />
                <a href="#"
                    style="
              display: block;
              font-size: 12px;
    ...
    <section class="bottle">
        ...
        ">
            ...
            <article style="width: 48%; text-align: left">
                <img src="/images/1733524487-versace_medusa-biggie-2024-campaign_sabrina-carpenter_1.jpeg"
                    alt="FOOD" style="width: 100%; height: auto; margin-bottom: 15px" />
                <a href="#"
                    style="
              display: block;
              font-size: 12px;
    ...
    <section class="disapp" style="margin-top: 100px">
        <div
          ...
          overflow: hidden;
        ">
            <img src="/images/image_39.jpeg" alt="Background"
